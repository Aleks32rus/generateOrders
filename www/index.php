...
</fieldset><button type="submit" value="Submit" id="getOrder" class="floating-button">Получить заявки</button></form>
...
'making':{'pre-scor':'15 - перед Пре-скорингом',
	'scor':'2 - перед скорингом'},
'decision':{'decisionAnalist':'3 - перед Принять решение под АНАЛИТИКОМ',
...
'decisionAnalist':{'1':'Рассмотрение РВ ОАНЗ',
	'2':'Рассмотрение ОАНЗ',
	'3':'Согласование ОАНЗ',}
...
</fieldset><button type="submit" value="Submit" id="getClient" class="floating-button">Получить код AБC</button></form>
